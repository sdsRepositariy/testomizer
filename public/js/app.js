...
if (document.getElementById('task_manager')) {
  Vue.component('task-list', __webpack_require__(48));
...
Component.options.__file = "resources/assets/js/components/tasks/TaskList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-345f7dca", Component.options)
  } else {
    hotAPI.reload("data-v-345f7dca", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-345f7dca", module.exports)
  }
}
