...
__webpack_require__(/*! ./fab_toggle */ "./resources/assets/js/fab_toggle.js");

__webpack_require__(/*! ./snackbar */ "./resources/assets/js/snackbar.js");

__webpack_require__(/*! ./sort_handler */ "./resources/assets/js/sort_handler.js");

__webpack_require__(/*! ./list_action_modal_loader */ "./resources/assets/js/list_action_modal_loader.js");

__webpack_require__(/*! ./submit_modal_form */ "./resources/assets/js/submit_modal_form.js");

__webpack_require__(/*! ./submit_modal_list */ "./resources/assets/js/submit_modal_list.js");

__webpack_require__(/*! ./view_modal_list */ "./resources/assets/js/view_modal_list.js");
...
window.$ = __webpack_provided_window_dot_jQuery = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // require('bootstrap-sass'); 
...
/***/ "./resources/assets/js/fab_toggle.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/fab_toggle.js ***!
  \*******************************************/
/*! no static exports found */
  ...
  $(function () {
    $("#action_menu").on("click", function () {
      ...
      if (!actionMenu.children().is(".transforming-box")) {
        ...
        actionMenu.append(dropdownMenu).find(".dropdown-menu").wrap('<div class="transforming-box">' + '<div class="content-wrapper" id="action_menu_target">' + '</div></div>');
      ...
      var buttonBottom = parseInt($(this).css("bottom")); //Get button size

      var buttonHeight = $(this).outerHeight();
      var buttonWidth = $(this).outerWidth(); //Get initial block size

      var initialHeight = actionMenu.find(".transforming-box").outerHeight();
      var initialWidth = actionMenu.find(".transforming-box").outerWidth(); //Get dropdown menu size
...
/***/ "./resources/assets/js/list_action_modal_loader.js":
/*!*********************************************************!*\
  !*** ./resources/assets/js/list_action_modal_loader.js ***!
  \*********************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
  ...
  $.fn.listActionModalLoader = function (settings) {
    ...
    function getContent(event) {
      event.preventDefault();
      var target = $(event.currentTarget); //Prevent call for disabled link
      ...
      $.ajax({
        ...
        data: {
          parent_folder: target.attr(self.options.parentFolderAttr)
        }
      }).done(function (html) {
...
(function ($) {
  ...
  var pluginName = "snackbar"; // key using in $.data()
  ...
  var defaults = {
    ...
    container: "#app",
    fab: "#action_menu",
    fabWrapper: ".action-menu-fab",
    //in case if wrapper positioned 
    template: '<div class="snackbar">' + '<div class="snackbar-content"></div>' + '</div>'
  ...
  function fabShiftUp($this) {
    var $fab;
    $fab = $("body").find($this.$fab); //Check if FAB exists

    if ($fab.length == 0) {
      return;
    }

    var $fabWrapper = $fab.parent($this.options.fabWrapper); //Check if FAB displayed
  ...
  function getContentType($this) {
    ...
    switch ($this.element.attr("data-snackbar-type")) {
      case 'success':
        contentType = "snackbar-success";
        break;

      case 'error':
        contentType = "snackbar-error";
        break;

      default:
        contentType = $this.options.type;
        break;
    }
  ...
  Plugin.prototype = {
    ...
    show: function show() {
      ...
      this.$container.append(this.$template).find(".snackbar-content").addClass(contentHeight + " " + getContentType(this));
      fabShiftUp(this);
      var self = this;
      this.$template.slideDown(this.options.duration).delay(this.options.delay).slideUp(this.options.duration, function () {
        self.destroy();
      });
    },
  ...
  $.fn[pluginName] = function (options) {
    ...
    if (plugin instanceof Plugin) {
      ...
      if (typeof options !== 'undefined') {// plugin.init(options);
      }
    } else {
...
/***/ "./resources/assets/js/sort_handler.js":
/*!*********************************************!*\
  !*** ./resources/assets/js/sort_handler.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./resources/assets/js/submit_modal_form.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/submit_modal_form.js ***!
  \**************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function ($) {
  ...
  $.fn.submitModalForm = function (settings) {
    ...
    function submit(event) {
      event.preventDefault();
      var modal = $(self.options.modal); // A hack to force the browser to display the native HTML5 error messages.
...
/***/ "./resources/assets/js/submit_modal_list.js":
/*!**************************************************!*\
  !*** ./resources/assets/js/submit_modal_list.js ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/js/view_modal_list.js":
/*!************************************************!*\
  !*** ./resources/assets/js/view_modal_list.js ***!
  \************************************************/
/*! no static exports found */
...
__webpack_require__(/*! /var/www/html/testomizer/resources/assets/js/app.js */"./resources/assets/js/app.js");
module.exports = __webpack_require__(/*! /var/www/html/testomizer/resources/assets/sass/app.scss */"./resources/assets/sass/app.scss");
