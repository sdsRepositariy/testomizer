...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used to manage users data.
    |
    */
    ...
    'attention' => 'Attention! Upload possible for files with extention: xls, xlsx, ods. The sheet must be properly formatted as shown below. The first row must contents follow column names: level, stream, last_name, first_name, middle_name, birthday.',
    'successfully_uploaded' => 'The user list was successfully uploaded!',
