	...
	<div>
		<div class="app-header clearfix">
			@if($folder->exists)
				...
				<a class="btn btn-app-icon-primary btn-app-round-icon" href="{{ url('tests') }}">
				@else
			...
			@else
				<div class="app-header-text">@lang('admin/tests.test_list')</div>
			@endif			
		</div>
		<div class="subheader clearfix">
			<div class="row">
				<div class="col-xs-6 hidden-lg hidden-md">
					...
					<div class="text-muted pull-left">@lang('admin/tests.groups')</div>
					@else
					<div class="text-muted pull-left">@lang('admin/tests.tests')</div>
					@endif
				</div>
				<div class="col-xs-6">
