...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12">
      ...
      @endif
      @if ( $errors->has('teacher_error') )
      <div class="alert alert-danger alert-dismissable">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        {{ $errors->first('teacher_error') }}
      </div>
      @endif 
          ...
          <div class='row'>
            ...
            <div class="col-sm-6 col-xs-12 col-md-5">
              <div class="text-right">
                @if($user->exists === true)
                  @if (\Gate::allows('update', 'user-'.$user->role->role))
                  <div class="btn-group">
        ...
        <div class="panel-body">
          ...
          {{ csrf_field() }}
            ...
            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
              ...
              <div class="col-md-8 col-lg-6">
                <input id="email" type="email" class="form-control" name="email" value="{{ old('email', $user->email) }}" {{ (Request::is('*/edit')||Request::is('*/create')) ? '' : 'readonly' }} required>
            ...
            <div class="form-group {{ $errors->has('role_id') ? ' has-error' : '' }}">
              <label for="role_id" class="col-md-3 col-lg-3 control-label">@lang('admin/users.role')</label>
              <div class="col-md-4 col-lg-3">
                <select id="role_id" class="form-control" name="role_id" {{ (Request::is('*/edit')||Request::is('*/create')) ? '' : 'disabled' }}>
                    @foreach ($roles as $role)
                      <option value="{{ $role->id }}" {{ $filter['role'] == $role->id ? 'selected' : ''}}>
                      {{ ucfirst($role->role) }}
                      </option>
                    @endforeach
                    </select>
            ...
            @if($user->exists === true && !Request::is('*/edit') && \Gate::allows('update', 'user-'.$user->role->role))
            <div class="row">
