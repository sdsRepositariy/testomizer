          ...
          {{ csrf_field() }}
            ...
            <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
              ...
              <div class="col-md-4 col-lg-3">
                <input id="phone_number" type="number" class="form-control" name="phone_number" value="{{ old('phone_number', $user->phone_number) }}" {{ (Request::is('*/edit')||Request::is('*/create')) ? '' : 'readonly' }}>
